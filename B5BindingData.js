...
export default class B5BindingData extends Component {
    icon1 = { icon: require('./src/Pictures/angry.png'), text: 'Tôi đang giận' }
    icon2 = { icon: require('./src/Pictures/care.png'), text: 'Tôi quan tâm bạn' }
    icon3 = { icon: require('./src/Pictures/haha.png'), text: 'Tôi đang vui' }
    icon4 = { icon: require('./src/Pictures/like.png'), text: 'Ủng hộ bạn nè' }
    icon5 = { icon: require('./src/Pictures/love.png'), text: 'Tôi đang yêu' }
    icon6 = { icon: require('./src/Pictures/sad.png'), text: 'Tôi đang buồn' }
